...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -1.772  # This is APPROXIMATELY the correct answer.
    answer = problem1a(4, 7)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -0.249  # This is APPROXIMATELY the correct answer.
    answer = problem1a(12, 15)
    print()
...
def run_test_problem1b():
    ...
    # Test 4:
    expected = 36  # This is APPROXIMATELY the correct answer.
    answer = problem1b(12, 15)
    print()
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
